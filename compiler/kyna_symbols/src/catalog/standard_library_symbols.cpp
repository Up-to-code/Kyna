...
const std::array symbols{
    ...
    StandardLibrarySymbol{"createQueue", true, 0, 0, {}, Kind::Any, type("array")},
    StandardLibrarySymbol{"enqueue", true, 2, 2, arrayValue, Kind::Any, type("void")},
    StandardLibrarySymbol{"dequeue", true, 1, 1, oneArray, Kind::Any, type("any")},
    StandardLibrarySymbol{"peekQueue", true, 1, 1, oneArray, Kind::Any, type("any")},
    StandardLibrarySymbol{"queueIsEmpty", true, 1, 1, oneArray, Kind::Any, type("bool")},
    ...
    StandardLibrarySymbol{"copyFile", true, 2, 2, twoStrings, Kind::Any, type("int")},
    ...
    StandardLibrarySymbol{"timeNow", true, 0, 0, {}, Kind::Any, type("int")},
    StandardLibrarySymbol{"timeSleep", true, 1, 1, oneInteger, Kind::Any, type("void")},
    StandardLibrarySymbol{"cryptoSha256", true, 1, 1, oneString, Kind::Any, type("str")},
    ...
    StandardLibrarySymbol{"parseIP", true, 1, 1, oneString, Kind::Any, TypeRef{"str", true, {}}},
    ...
    StandardLibrarySymbol{"slogInfo", true, 1, 2, stringValue, Kind::Any, type("void")},
    StandardLibrarySymbol{"slogWarn", true, 1, 2, stringValue, Kind::Any, type("void")},
    StandardLibrarySymbol{"slogError", true, 1, 2, stringValue, Kind::Any, type("void")},
    ...
    StandardLibrarySymbol{"slog", false, 0, 0, {}, Kind::Any, type("object")},
